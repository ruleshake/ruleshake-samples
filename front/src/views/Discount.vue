<template>
    ...
    <div class="container mx-auto flex flex-wrap py-6">
                    ...
                    <div class="w-full h-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col justify-between">
                        <div>
                            <div class="flex justify-end mt-2">
                                <span class="text-right bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-blue-400 border border-blue-400">
                                    {{ article.category }}
                                </span>
                            </div>
        ...
        <aside class="w-1/3 flex flex-col items-center px-3">
            ...
            <div class="w-full bg-white shadow flex flex-col my-2 p-6 font-mono">
